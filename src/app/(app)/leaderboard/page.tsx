    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Most active solvers across the community.
        </p>
      </div>
        ...
        <TabsContent value="weekly">
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>
                Snapshot is refreshed nightly by the cron job.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Rows rows={weekly} />
        ...
        <TabsContent value="all">
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>
                Total AC submissions across LeetCode + Codeforces.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Rows rows={allTime} />
  ...
  if (rows.length === 0)
    return (
      <p className="p-4 text-sm text-muted-foreground">
        No data yet — invite some friends!
      </p>
    );
  return (
