...
export const NEETCODE_150: NeetSection[] = [
  ...
  },
  {
    ...
    problems: [
      ...
      { title: "Longest Substring Without Repeating Characters", lcSlug: "longest-substring-without-repeating-characters" },
      { title: "Longest Repeating Character Replacement", lcSlug: "longest-repeating-character-replacement" },
  ...
  },
  {
    ...
    problems: [
      ...
      { title: "Lowest Common Ancestor of a BST", lcSlug: "lowest-common-ancestor-of-a-binary-search-tree" },
      ...
      { title: "Construct Binary Tree From Preorder And Inorder Traversal", lcSlug: "construct-binary-tree-from-preorder-and-inorder-traversal" },
  ...
  },
  {
    ...
    problems: [
      ...
      { title: "Design Add and Search Words Data Structure", lcSlug: "design-add-and-search-words-data-structure" },
  ...
  },
  {
    ...
    problems: [
      ...
      { title: "Letter Combinations of a Phone Number", lcSlug: "letter-combinations-of-a-phone-number" },
  ...
  },
  {
    ...
    problems: [
      ...
      { title: "Number of Connected Components In An Undirected Graph", lcSlug: "number-of-connected-components-in-an-undirected-graph" },
  ...
  },
  {
    ...
    problems: [
      ...
      { title: "Best Time to Buy And Sell Stock With Cooldown", lcSlug: "best-time-to-buy-and-sell-stock-with-cooldown" },
      ...
      { title: "Longest Increasing Path In a Matrix", lcSlug: "longest-increasing-path-in-a-matrix" },
  ...
  },
  {
    ...
    problems: [
      ...
      { title: "Merge Triplets to Form Target Triplet", lcSlug: "merge-triplets-to-form-target-triplet" },
  ...
  },
  {
    ...
    problems: [
      ...
      { title: "Minimum Interval to Include Each Query", lcSlug: "minimum-interval-to-include-each-query" },
    ],
  },
  {
    name: "Math & Geometry",
